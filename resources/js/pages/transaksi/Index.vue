<template>
    <div>
        ...
        <v-simple-table class="table table-striped table-dark">
    ...
    methods: {
        ...
        addItem() {
            if (this.$refs.form.validate()) {
                ...
                axios.post('/api/pelanggan', formData).then(res => {
        ...
        updateItem(id) {
            ...
            axios.post(`/api/pelanggan/${id}`, formData).then(res => {
                this.dialog = false;
        ...
        deleteItem(id) {
            this.$swal({
                ...
                if (result.value) {
                    axios.delete(`/api/pelanggan/${id}`).then(res => {
